...
import { historyChange, showFooterChange, showHeaderMenuChange, showSideNavChange, sideNavItemsChange } from '../components/layout/state/layout.actions';
...
export class LayoutService {
  ...
  initializeLayout=(layoutConfig:LayoutState)=>{
    ...
    this.store.dispatch(showHeaderMenuChange({showHeaderMenu:layoutConfig.showHeaderMenu}))
  }
}
