...
import { DeleteDirectionStart, getDirectionStart, isModelProgressBarChange, modelPageChange, modelPageTypeChange, PostDirectionStart, PutDirectionStart } from '../../state/model.actions';
...
export class DirectionComponent implements OnInit {
  ...
  deleteModel=(id:string)=>{
    this.store.dispatch(DeleteDirectionStart({id:id}))
  }
