...
enum ActionTypes {
    ...
    GET_ENTITIES_FAILURE = '[Gestion Page] Get Fonctions Failure',
...
export const getEntitiesFailure=createAction(ActionTypes.GET_ENTITIES_FAILURE,props<{error:string}>())
